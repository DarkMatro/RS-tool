...
class StyleSheetBase:
    ...
    def content(self, theme=Theme.AUTO):
        ...
        t = theme.DARK if is_dark_theme() else theme.LIGHT
        return getStyleSheetFromFile(self.path(t))
...
def toggle_theme(save=False):
    ...
    save: bool
        whether to save the change to config file
    """
    theme = Theme.LIGHT if is_dark_theme() else Theme.DARK
    setTheme(theme, save)
