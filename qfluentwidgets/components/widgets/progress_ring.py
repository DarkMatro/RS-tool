...
from ...common.style_sheet import themeColor, is_dark_theme
...
class ProgressRing(ProgressBar):
    ...
    def __init__(self, parent=None, useAni=True):
        ...
        self.text_color_inverted = False
    ...
    def set_text_theme_invert(self, b: bool):
        if b:
            self.text_color_inverted = True
    ...
    def _drawText(self, painter: QPainter, text: str):
        ...
        if not self.text_color_inverted:
            text_color = Qt.white if is_dark_theme() else Qt.black
        else:
            text_color = Qt.white if not is_dark_theme() else Qt.black
    ...
    def paintEvent(self, e):
        ...
        # draw background
        bc = self.darkBackgroundColor if is_dark_theme() else self.lightBackgroundColor
