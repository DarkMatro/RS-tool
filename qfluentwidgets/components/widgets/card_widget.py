...
from ...common.style_sheet import is_dark_theme, FluentStyleSheet
...
class CardWidget(BackgroundAnimationWidget, QFrame):
    ...
    def _normalBackgroundColor(self):
        return QColor(255, 255, 255, 13 if is_dark_theme() else 170)

    def _hoverBackgroundColor(self):
        return QColor(255, 255, 255, 21 if is_dark_theme() else 64)

    def _pressedBackgroundColor(self):
        return QColor(255, 255, 255, 8 if is_dark_theme() else 64)
...
class ElevatedCardWidget(SimpleCardWidget):
    ...
    def _hoverBackgroundColor(self):
        return QColor(255, 255, 255, 16) if is_dark_theme() else QColor(255, 255, 255)

    def _pressedBackgroundColor(self):
        return QColor(255, 255, 255, 6 if is_dark_theme() else 118)
