...
class CommandButton(TransparentToggleToolButton):
    ...
    def paintEvent(self, e):
        ...
        if not self.isChecked():
            painter.setPen(Qt.white if is_dark_theme() else Qt.black)
        else:
            painter.setPen(Qt.black if is_dark_theme() else Qt.white)
...
class CommandSeparator(QWidget):
    ...
    def paintEvent(self, e):
        ...
        painter.setPen(QColor(255, 255, 255, 21)
                       if is_dark_theme() else QColor(0, 0, 0, 15))
...
class CommandBarView(FlyoutViewBase):
    ...
    def paintEvent(self, e):
        ...
        painter.setBrush(
            QColor(40, 40, 40) if is_dark_theme() else QColor(248, 248, 248))
        painter.setPen(
            QColor(56, 56, 56) if is_dark_theme() else QColor(233, 233, 233))
