...
from ...common.style_sheet import FluentStyleSheet, themeColor, is_dark_theme
...
class SpinFlyoutView(FlyoutViewBase):
    ...
    def paintEvent(self, e):
        ...
        # painter.setBrush(
        #     QColor(46, 46, 46) if is_dark_theme() else QColor(249, 249, 249))
        # painter.setPen(
        #     QColor(0, 0, 0, 51) if is_dark_theme() else QColor(0, 0, 0, 15))
