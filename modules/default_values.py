...
def baseline_parameter_defaults() -> dict[dict[float | int]]:
    return {'Poly': {'poly_deg': 5},
            ...
            'iModPoly': {'poly_deg': 6, 'grad': 1e-3, 'n_iter': 250, 'num_std': 0.},
            'ExModPoly': {'poly_deg': 7, 'grad': 1e-6, 'n_iter': 100, 'quantile': 1e-5, 'scale': .5, 'num_std': 3.,
                          'fill_half_window': 2},
            'Penalized poly': {'poly_deg': 2, 'grad': 1e-3, 'n_iter': 250, 'alpha_factor': 0.99999},
            ...
            'Noise Median': {'interp_half_window': 5},
            'RIA': {'grad': 1e-6},
