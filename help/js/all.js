...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Интерфейс ","2. Пошаговая инструкция по примеру проекта","3. Алгоритмы","Функционал программы","1.1. Меню","1.2. Настройки программы","1.3. Кнопки графиков","1.4. Вкладка Preprocessing","1.5. Вкладка Fitting","1.6. Вкладка Datasets","1.7. Вкладка Stat analysis","1.8. Вкладка Predict","2.1. Загрузка файлов и создание проекта","2.2. Preprocessing","2.3. Fitting","2.4. Обучение классификаторов","2.5. Проверка работы классификаторов и создание production project","3.1. Нормализация","3.2. Сглаживание","3.3. Baseline correction","Ex-Mod-Poly","Алгоритм декомпозиции спектра"],
    DREX_NODE_LINKS: ["index.htm","interfejs_.htm","poshagovaya_instruktsiya_po_primeru_proekta.htm","3__algoritmy.htm","funktsional_programmy.htm","menyu.htm","1_2__nastrojki_programmy.htm","1_3__knopki_grafikov.htm","1_4__vkladka_preprocessing.htm","1_5__vkladka_fitting.htm","1_6__vkladka_datasets.htm","1_7__vkladka_stat_analysis.htm","1_8__vkladka_predict.htm","2_1__zagruzka_fajlov_i_sozdanie_proekta.htm","2_2__preprocessing.htm","2_3__fitting.htm","2_4__obuchenie_klassifikatorov.htm","2_5__proverka_raboty_klassifikatorov_i_sozdanie_production_project.htm","3_1__normalizatsiya.htm","3_2__sglazhivanie.htm","3_3__baseline_correction.htm","ex_mod_poly.htm","algoritm_dekompozitsii_spektra.htm"],
    DREX_NODE_CHILD_START: [1,5,13,18,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23],
    DREX_NODE_CHILD_END: [5,13,18,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23,23],
    DREX_MENU_TYPE: 1,
